...
#NOTE:- THIS PROGRAM ASSUMES YOU HAVE CHROME VERSION 83 AS YOUR BROWSER AND YOU HAVE DOWNLOADED THE ENTIRE REPOSITORY FROM GITHUB
#INSTEAD OF JUST THIS PROGRAM CAUSE IF YOU JUST COPIED IT WILL NOT WORK.
